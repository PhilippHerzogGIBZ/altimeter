...
// WiFi Settings
// @ TODO Ändern auf ihre Werte
const char* ssid = "HERZOG";
const char* password = "Herzog1234";

// IOT Einstellungen
// @ TODO wird von Philipp Herzog zur Verfügung gestellt
...
String SendHTML()
{
  // @ TODO Website gemäss ihren Bedürfnissen anpassen		
  String ptr = "<!DOCTYPE html> <html>\n";
  ptr +="<head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=no\">\n";
  ptr +="<title>Webserver Team ????</title>\n";
  ...
  ptr +="<body>\n";
  ptr +="<div id=\"webpage\">\n";
  ptr +="<h1>Hoehenmessgeraet Team ???</h1>\n";
